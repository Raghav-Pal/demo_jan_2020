...
WebUI.verifyElementPresent(findTestObject('Page_OrangeHRM/a_Welcome Admin'), 5)

WebUI.delay(3)

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_Welcome Admin'))

WebUI.verifyElementClickable(findTestObject('Page_OrangeHRM/a_Logout'), FailureHandling.STOP_ON_FAILURE)
